    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          ...
          backgroundColor:  Color(0xff1F5B4D),
          behavior: SnackBarBehavior.floating,
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        ));
      }
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [ Color(0xff1F5B4D), Color(0xff1F5B4D)],
        ),
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    icon: const Icon(Icons.history, size: 16, color: Color(0xff1F5B4D)),
                    label: Text(
                      'Lihat semua (${_history.length - 3} lainnya)',
                      style: const TextStyle(color: Color(0xff1F5B4D), fontWeight: FontWeight.w600),
                    ),
                    style: OutlinedButton.styleFrom(
                      side: const BorderSide(color: Color(0xff1F5B4D)),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(price,
                    style: const TextStyle(
                        fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xff1F5B4D))),
